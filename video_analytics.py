...
if __name__ == "__main__":
    ...
    text = Text(win)  
    text.insert(INSERT,text_output)  
    text.pack() 
    label1=Label(win, text="\nNegative "+neg+"\nNeutral "+neu+"\nPositive "+pos+"\nCompound "+comp, font=("Times",30,"bold"))
    label1.pack()
    win.mainloop()